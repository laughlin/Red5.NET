...
public class VideoData extends BaseEvent implements IoConstants, IStreamData, IStreamPacket {
    ...
    public static class FrameType {
		...
		public static final FrameType KEYFRAME = new FrameType();
		public static final FrameType INTERFRAME = new FrameType();
		public static final FrameType DISPOSABLE_INTERFRAME = new FrameType();
	}
