...
public interface IProviderService extends IScopeService {
	 ...
	 */
	class INPUT_TYPE {
		public static final INPUT_TYPE NOT_FOUND = new INPUT_TYPE();
		public static final INPUT_TYPE LIVE = new INPUT_TYPE();
		public static final INPUT_TYPE VOD = new INPUT_TYPE();
	};
