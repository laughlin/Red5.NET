...
implements IBWControlService {
	 ...
	 * @sharpen.enum
	 */
	protected static class TokenRequestType {
		public static final TokenRequestType BLOCKING = new TokenRequestType();
		public static final TokenRequestType NONBLOCKING = new TokenRequestType();
		public static final TokenRequestType BEST_EFFORT = new TokenRequestType();
	}
